...
public class CSVReader {
    public static void handle(ArgsName argsName) throws Exception {
        ...
        try (var scanner = new Scanner(file)
            ...
            List<String> param = List.of(scanner.nextLine().split(argsName.get("delimiter")));
            ...
            while (scanner.hasNext()) {
                joiner = new StringJoiner(argsName.get("delimiter"));
                param = List.of(scanner.nextLine().split(argsName.get("delimiter")));
